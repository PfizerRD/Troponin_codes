...
def iPSC_pipeline(RootPath,OutputPath,subfolder,ds=1):
    ...
    SC_diff_pos, _ = find_peaks(SC_diff, height= SC_diff_max*0.75,distance=180)
    SC_diff_neg, _ = find_peaks(-SC_diff, height= -SC_diff_min*0.75,distance=180)
    ...
    dist_peak, _ = find_peaks(1-SC_values_ref[:-10], height=  SC_inv_height*0.75,distance=180)
    ...
    rightBound2 = SC_diff_neg+half_width2+5
...
if __name__ == "__main__":
    ...
    RootPath = 'Z:\\pangj05\\RDRU_MYBPC3_2021\\20211020DataSetAnalysis\\Plates1_4'
    OutputPath = 'Z:\\pangj05\\RDRU_MYBPC3_2021\\20211020DataSetAnalysis\\Plates1_4_output1104_no_video'
